...
function BudgetPage() {
    ...
    if (isLoading) {
        return <div className="p-8 text-center text-sm font-medium">Đang tải danh sách hũ ngân sách lớn...</div>;
    }
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 bg-white p-5 rounded-xl border shadow-xs">
                <div>
                    <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">Danh Sách Hũ Lớn & Chu Kỳ</h1>
