  ...
  1: [
    {
      id: 101,
      period_id: 1,
      name: '🛒 Nhu cầu thiết yếu (NEC - 55%)',
      allocated_amount: 11000000,
      current_balance: 4500000,
    },
    {
      id: 102,
      period_id: 1,
      name: '🎓 Giáo dục & Phát triển (EDU - 10%)',
    ...
    },
    {
      id: 103,
      period_id: 1,
      name: '🎮 Hưởng thụ & Giải trí (PLAY - 10%)',
      allocated_amount: 2000000,
    ...
    },
    {
      id: 104,
      period_id: 1,
      name: '💰 Tiết kiệm dài hạn (LTSS - 10%)',
      allocated_amount: 2000000,
      current_balance: 2000000,
    },
    {
    ...
    },
    {
      id: 106,
      period_id: 1,
      name: '💝 Quỹ từ thiện / Cho đi (GIVE - 5%)',
...
function BudgetDetailPage() {
  ...
  const jars =
    serverJars && serverJars.length > 0 ? serverJars : MOCK_JARS[currentPeriod] || MOCK_JARS[1];
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 bg-white p-4 rounded-xl border shadow-xs">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400 block">
            Kế hoạch ngân sách phân bổ
          </span>
          <h1 className="text-xl font-black text-slate-800">
            Chi tiết cấu trúc Hũ lớn #{currentPeriod}
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base font-bold">Tài khoản ví khả dụng</CardTitle>
            </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {jars.map((j) => (
                <div
                  key={j.id}
                  className="border p-4 rounded-xl space-y-2 bg-white shadow-xs group relative"
                >
                  ...
                  <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden mt-1">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, (j.current_balance / j.allocated_amount) * 100)}%`,
                      }}
                    />
                  </div>
                  <div className="flex justify-between text-xs pt-1">
                    <span className="text-slate-500">
                      ...
                      <strong className="text-slate-700">
                        {j.current_balance.toLocaleString()}đ
                      </strong>
                    </span>
                    <span className="text-slate-400">
                      Hạn mức: {j.allocated_amount.toLocaleString()}đ
                    </span>
                  </div>
                </div>
              ))}
