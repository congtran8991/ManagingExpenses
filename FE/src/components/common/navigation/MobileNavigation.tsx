    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-100 shadow-xl pb-safe">
            <div className="flex justify-around items-center h-16 px-2">
                ...
                <Link
                    to="/dashboard"
                    className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${isActive('/dashboard') ? 'text-indigo-600 font-bold' : 'text-slate-400'
                        }`}
                >
                ...
                <Link
                    to="/budgets"
                    className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${isActive('/budgets') ? 'text-indigo-600 font-bold' : 'text-slate-400'
                        }`}
                >
                    <span className="text-xl">📂</span>
                ...
                <Link
                    to="/transactions"
                    className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${isActive('/transactions') ? 'text-indigo-600 font-bold' : 'text-slate-400'
                        }`}
                >
                    <span className="text-xl">📜</span>
